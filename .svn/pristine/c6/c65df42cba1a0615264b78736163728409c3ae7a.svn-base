...
$(document).ready(function(){
	//动态添加大转盘的奖品与奖品区域背景颜色
	turnplate.restaraunts = [ "赛睿布垫(大小\颜色可多选）", "谢谢参与", "nidi键盘\限量款", "屏保(任意款手机型号)", "500元\n话费卡", "外星人电脑"];
	turnplate.colors = ["#f95859", "#fd7576", "#f95859", "#fd7576","#f95859", "#fd7576"];
	...
	$('.close_xcy').click(function(){
		$('#xcy-main').fadeOut();
		//$('#ml-main').fadeIn();
	});
	$('.close_cy').click(function(){
		$('#cy-main').fadeOut();
		//$('#ml-main').fadeIn();
	});
	...
	$('.close_rjl').click(function(){
		$('#rjl-main').fadeOut();
	});
	$('.renjl').click(function(){
		$('#rjl-main').fadeOut();
	});

	// function ljr(){ 
	// 			if($(".renjl").css("display")=='none'){
	// 				$(".renjl").css("display","block");
	// 			}else{
	// 				$(".renjl").css("display","none");
 // 					}
 // 				}
