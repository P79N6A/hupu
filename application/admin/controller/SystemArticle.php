...
class SystemArticle extends Base
{
    ...
    public function getList()
    {
        ...
        $data = $model
            ->alias("A")
            ->field('A.*,C.name as at_name,D.username')
            ->join("article_type C ", "C.id=A.type_id", 'left')
            ->join("admin_user D ", "D.user_id=A.admin_id", 'left')
            ->order('A.id desc')
            ->where($condition);
