...
//        $this->assign('lists',$lists);
    ...
    public function getList()
    {
        ...
        $data = $model
            ->alias("A")
            ->join('user_detail B', 'B.user_id=A.uid', 'left')
            ->join('luck C', 'A.lid=C.id', 'left')
            ->where($condition)
            ->field('A.*,B.nick_name,B.mobile,C.name as jname,C.url')
