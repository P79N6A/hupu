...
class GcardText extends Base
{
    ...
    public function getList()
    {
        ...
        $data = $model
            ->alias("A")
            ->join('gcard C','C.id=A.gcard_id','left')
            ->where($condition)
            ->field('A.*,C.title')
            ->order('A.id desc');
    ...
    public function add(Request $request)
    {
        ...
        //查找贺卡列表
        $gcard_list = Db::name('gcard')->select();
    ...
    public function edits()
    {
        ...
        $id = input('id');
        $res = Db::name('gcard_text')->where(['id' => $id])->find();
        ...
        return $this->fetch('GcardText/edit');
    }
